...
const MobileHome = () => {
    ...
    return (
        <div className="mobile-home">
          ...
          <div className="mobile-home-delivery-options">
            {/* Checkboxes and dropdowns grouped together */}
            <div className="mobile-checkbox-dropdown-container">

              {/* Pickup Checkbox and Dropdown */}
              <div className="mobile-checkbox-dropdown">
                <input
                  type="checkbox"
                  id="pickup"
                ...
                {isPickupChecked && homeDeliveryOptions.length > 0 && selectedOption1 && (
                  <div className="mobile-pickup-location">
                    <select
                      className="mobile-pickup-dropdown dropdown"
              ...
              <div className="mobile-checkbox-dropdown">
                ...
                {isDoor2DoorChecked && homeDeliveryOptions.length > 0 && selectedOption2 && (
                  <div className="mobile-home-delivery">
                    <select
                      className="mobile-home-delivery-dropdown dropdown"
