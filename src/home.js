  ...
  return (
    <div className="home">
      <div className="input-container">
        <div className="item-with-length">
          <div className="item-type">
            <h2 className="item-type-title">Item</h2>
          ...
          {(selectedItemOption1 === "Monitor" || selectedItemOption1 === "TV") &&
            <div className="device-length-input">
              <h4 className="device-length-title">Device Length</h4>
              ...
              <div className="checkbox-dropdown">
                ...
                {isPickupChecked && homeDeliveryOptions.length > 0 && selectedOption1 && (
                  <div className="pickup-location">
                    <select
                      className="pickup-dropdown dropdown"
        ...
        <div className="weight-input">
          <h2 className="weight-tite">Weight</h2>
        ...
        {/* Calculate button */}
        <div>
          <Button className="calculate-button" type="primary" shape="round" onClick={handleCalculate}>
            Calculate
          </Button>
        </div>
      </div>
